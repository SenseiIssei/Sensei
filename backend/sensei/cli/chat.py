"""`sensei chat` — interactive console chat with streaming and slash commands."""
...
BANNER = r"""
  ...
  Self-hosted AI · Token Compression
...
async def cli_chat() -> None:
    ...
    print(
        ...
        f"Compression: {'on' if settings.compression_enabled else 'off'}"
    )
    print()
    ...
    if available:
        ...
        print()
        print("  Run 'sensei doctor' to see exactly what's missing.")
    print()
